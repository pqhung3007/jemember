...
const LessonCard = memo(function LessonCard({
  ...
  return (
    <Link
      href={`/lesson/${id}`}
      className="group relative rounded-2xl bg-gray-100 px-4 py-8 duration-200 hover:bg-indigo-700 hover:drop-shadow-md dark:bg-gray-800
      dark:hover:bg-indigo-700">
      <div className="flex items-center break-words text-2xl font-semibold">
        <p className="group-hover:text-indigo-50 dark:group-hover:text-indigo-200">
      ...
      <p className="pt-4 text-gray-500 group-hover:text-indigo-50 dark:group-hover:text-indigo-200">
