...
export default function Lesson() {
  ...
  let nextButtonStyle = index >= (cards == null ? 1 : cards.length) - 1 ? "bg-gray-700 cursor-not-allowed" : "bg-blue-700 cursor-pointer";
    ...
    <div className="bg-gray-900 text-gray-200 min-h-screen">
      ...
      <div className="p-4">
        ...
        <div className="max-w-[1500px] py-6 mx-auto flex items-center justify-center gap-[min(2vw,10px)]">
          ...
          <Flashcard isFront={isFront} setIsFront={setIsFront} info={cards[index]} />
